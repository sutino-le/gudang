            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control"
                        placeholder="Silahkan cari barang berdasarkan Kode / Nama Barang" id="cari">
                    <div class="input-group-append">
                        <button class="btn btn-outline-primary" type="button" id="btnCari"><i
...
function cariDataBarang() {
    ...
    $.ajax({
        ...
        dataType: "json",
        beforeSend: function() {
            $('.viewdetaildata').html('<i class="fas fa-spin fa-spinner"></i>');
        },
